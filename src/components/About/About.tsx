      ...
      <div className="about-row">
        ...
        <div className="header-column">
          <i className="section-subHeader">
            How our team was created, what we did in the beginning, what we are doing now and other trivia!
          </i>
      ...
      <div className="about-row2">
        <div className="col-text">
          ...
          <ReactMarkdown className="about-text">
            Our team was created in October 2020 by EWKD and Lifish. Although initially the name was just a placeholder
            it stuck around. At first we participated exclusively in local russian tourneys (and didn’t do that hot).
            All in all 2020 was a pretty rough year for our team (we didn't play often as well as didn't get any solid
            results and EWKD ended up joining a different team).
          </ReactMarkdown>
          <span className="section-subHeader">2021</span>
          <hr className="section-divider" style={{ width: '40%', marginTop: 0 }} />
          <p className="about-text">
            Nonetheless we continued to play and were improving as a team. Then came time for{' '}
          ...
          <p className="about-text">
            After the seeding tourney we got into division 8 (as expected) and got 4th in group (although we were very
            close to the 2nd and 3rd place teams). It was a really fun event but that's besides the point, the most
            important thing is that after the season ended our momentum didn't stop and we began taking part in more
            tournaments!
          </p>
          <p className="about-text">
            In 2021 we participated in many tourneys and got some good placements (1st place in LSL 13 Emerald Bracket,
            2nd place in LSL 15 Silver Bracket, 3rd place in URC x LoRule — a local ru-tournament).
          </p>
          <span className="section-subHeader">2022</span>
          <hr className="section-divider" style={{ width: '40%', marginTop: 0 }} />
          <ReactMarkdown className="about-text">
            As we participated in more and more tournaments we got better and better results! There were some ups and
            downs, but overall there were way more ups ~(˘▾˘~).
          </ReactMarkdown>
          <ReactMarkdown className="about-text">
            In May 2022 a very important tournament for our team was held — LSL 20! Although day 1 was a bit rough for
            us, on day 2 we got our act together and **won every set in Silver Bracket**! As a result we got our first
            money prize.
          </ReactMarkdown>
          <p className="about-text">
